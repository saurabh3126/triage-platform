                  ...
                  <form onSubmit={handleReviewSubmit} className="space-y-4 p-5 mt-2 bg-slate-50 border-2 border-black rounded-2xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <button type="button" onClick={() => setReviewStatus('Verified True')}
                        className={`py-3 text-xs font-black uppercase tracking-wider rounded-xl border-2 transition-all ${reviewStatus === 'Verified True' ? 'bg-[#FFD700] text-black border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]' : 'bg-white text-black border-black hover:bg-emerald-50 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]'}`}>
                        ✅ Verified True
                      </button>
                      <button type="button" onClick={() => setReviewStatus('Verified False')}
                        className={`py-3 text-xs font-black uppercase tracking-wider rounded-xl border-2 transition-all ${reviewStatus === 'Verified False' ? 'bg-[#FFD700] text-black border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]' : 'bg-white text-black border-black hover:bg-rose-50 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]'}`}>
                        ❌ Verified False
                      </button>
                    </div>
